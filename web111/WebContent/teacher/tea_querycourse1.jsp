...
<body >
<table width="1000" height="200" align="center" bordercolor="000000" border="1" cellpadding="3">
  <tr >
    ...
    <td><div align="center">操作</div></td>
  	 ...
  	 <c:forEach items="${courses}" var="course">
  		<tr >
    		 ...
    		 <td><div align="center"><a href="TeaQueryCourse2Servlet?courseno=${course.courseno }">查看</div></td>
  	   </tr>
  	 </c:forEach>	
   </table>
</body>
